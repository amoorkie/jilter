#!/usr/bin/env python3
"""
Ультра-чистый экспорт вакансий в PDF с максимальной очисткой
"""
...
class UltraCleanPDFExporter:
    """Ультра-чистый экспорт вакансий в PDF"""
    ...
    def ultra_clean_text(self, text: str) -> str:
        ...
        for line in lines:
            ...
            if any(keyword in line.lower() for keyword in [
                ...
                'insertbefore', 'async', 'text/javascript'
            ]):
                continue
    ...
    def export_vacancies_to_pdf(self, output_path: str = None) -> bool:
        ...
        if not output_path:
            ...
            output_path = f"vacancies_ultra_clean_{timestamp}.pdf"
        
        print("Ультра-чистый экспорт вакансий в PDF")
        print("="*50)
...
def main():
    ...
    # Создаем экспортер
    exporter = UltraCleanPDFExporter(db_path)
