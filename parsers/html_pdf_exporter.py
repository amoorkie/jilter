#!/usr/bin/env python3
"""
HTML PDF экспорт вакансий с красивым форматированием как в админке
"""
...
class HTMLPDFExporter:
    """HTML PDF экспорт с красивым форматированием"""
    ...
    def create_html_pdf(self, vacancies: List[Dict[str, Any]], output_path: str) -> bool:
        """Создание HTML PDF с красивым форматированием"""
        try:
            # HTML шаблон
            html_template = f"""
            <!DOCTYPE html>
    ...
    def export_vacancies_to_pdf(self, output_path: str = None) -> bool:
        ...
        if not output_path:
            ...
            output_path = f"vacancies_html_{timestamp}.pdf"
        
        print("HTML PDF экспорт вакансий с красивым форматированием")
        print("="*50)
        ...
        # Создаем PDF
        success = self.create_html_pdf(vacancies, output_path)
...
def main():
    ...
    # Создаем экспортер
    exporter = HTMLPDFExporter(db_path)
