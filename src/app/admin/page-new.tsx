...
import EnhancedMonitoringPanel from '@/components/EnhancedMonitoringPanel';

type FilterStatus = 'all' | 'pending' | 'approved' | 'rejected';
type TabType = 'vacancies' | 'parser' | 'monitoring';
          ...
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <ParsedVacancyView 
                  text={[
                    selectedVacancy.full_description,
                    selectedVacancy.description,
                    selectedVacancy.requirements && `Требования:\n${selectedVacancy.requirements}`,
                    selectedVacancy.tasks && `Задачи:\n${selectedVacancy.tasks}`,
                    selectedVacancy.conditions && `Условия:\n${selectedVacancy.conditions}`,
                    selectedVacancy.benefits && `Льготы:\n${selectedVacancy.benefits}`
                  ].filter(Boolean).join('\n\n')}
                />
              </div>
