...
export default function AdminPanel() {
  ...
  const getStatusBadge = (vacancy: VacancyRecord) => {
    if (vacancy.is_approved) {
      return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Одобрено</span>;
      ...
      return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">На модерации</span>;
    }
  };
        ...
        <div className="bg-white shadow">
          <div className="border-b border-gray-200">
            <div className="px-6 py-4">
              ...
              <p className="text-gray-600">Управление вакансиями и парсинг</p>
            </div>
