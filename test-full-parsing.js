...
async function testFullParsing() {
  console.log('🧪 Тестируем полный парсинг с Telegram и LinkedIn...');
  
  try {
    console.log('🚀 Запускаем парсинг с увеличенным лимитом...');
    
    // Сначала очистим базу данных, чтобы запустить парсинг
    console.log('🗑️ Очищаем базу данных...');
    await axios.delete('http://localhost:3000/api/admin/clear-db');
    ...
    console.error('❌ Ошибка при тестировании полного парсинга:', error.message);
  }
}
